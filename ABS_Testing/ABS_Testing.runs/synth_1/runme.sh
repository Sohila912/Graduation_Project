...
HD_PWD='C:/Users/Mariam Tamer/OneDrive/Desktop/GP/GP_Collision/GP_Collision/Graduation_Project/ABS_Testing/ABS_Testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ABS_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ABS_Controller.tcl

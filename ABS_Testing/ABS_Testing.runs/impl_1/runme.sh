...
HD_PWD='C:/Users/Mariam Tamer/OneDrive/Desktop/GP/GP_Collision/GP_Collision/Graduation_Project/ABS_Testing/ABS_Testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ABS_Controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ABS_Controller.tcl -notrace
